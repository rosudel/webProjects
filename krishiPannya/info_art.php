        ...
        while($row=mysqli_fetch_array($result_category)){
          ...
          $_SESSION['cat'] = $row['art_category'];
            echo '<p class="head-title" >'. $row['art_title'].'</p>
                  ...
                  <p class="artist">'.$row['user_fname'].' '.$row['user_mname'].' '.$row['user_lname'].'<br>'.$row['art_category'].'<br>পরিমাণ: '.$row['art_stock'].'<br>মূল্যঃ '.$row['art_price'].'টাকা </p><br><br>';
if($row['art_status'] == 'SOLD'){
    echo '<p class="soldbutton">'.$row['art_status'].' for<br> &#8750;'.$row['art_price'].'.00</form>';
       ...
       echo '<input  class="buybutton" type="submit" name="buy" value="ক্রয় করুন "></form>';
     }

echo '
           <br><br><p class="contact"> বিক্রেতার সাথে যোগাযোগ<br>'.$row['user_contact'].

                 '<hr class="hr"><p class="about">পণ্যটি সম্পর্কে</p>  <br><br> <p class="desc">'.$row['art_description'];
           //rating
...
if ($count>0){
          ...
          echo' <p class="rate"><form action="rate_art.php" class="rate" method = "POST"><br><br>রেট করুন:&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <input id="ratebtn" type="submit" name="submit" value ="সাবমিট">
                  </p></form>
     ...
     echo '<div id = "post-comment">
                      ...
                      if(isset($_SESSION['USER_ID'])){
                           echo'<tr>
                                    ...
                                    <td>
                                       কমেন্ট বক্স:<br><textarea name="message" id="tmessageid" style="width:1150px;height:100px; border-radius:8px;border:1px solid none;"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" id="one">
                                    ...
                                    <td>
                                        <input id="commentbtn"  type="submit" name="submit" id="commentbtn" value="পোস্ট করুন">
                                    </td>
                                </tr>
                        </table>
                    </form>';
