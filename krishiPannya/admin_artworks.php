...
function YNconfirm() {
    ...
    <p><h1 class="head-table" >স্টক </h1>
       <h1 class="head-user" >পণ্য সমূহ</h1><br> <hr class="hr" style="border-bottom: 2px solid #2d70d5;">
    </p>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        '<a  href=info_art.php?id='.$row['art_id'].' class="desc-title"> '.$row['art_title'].' </a>
                                         ...
                                         <p class="desc-content" style="float: right;">&#8750;'.$row['art_price'].'</p> <br>
