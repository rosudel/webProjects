...
function YNconfirm() {
    ...
    <div class="img">
        ...
        <?php
$id = $_SESSION['USER_ID'];
echo '<p><h1 class="head-my">আমার</h1>
         <h1 class="head-collections">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ক্রয়কৃত পণ্য</h1><hr class="hr">
      </p>';
        ...
        {
           echo '<br><br><br><br><br><br><br><br><br><br><br><br><br><br><h1 align="Center">এখন পর্যন্ত নেই</h1>';
         }
        else{
