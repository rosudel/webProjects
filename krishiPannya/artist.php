...
<html>
 ...
 <body>
     <p class="name" align = "left">নাম:

     <input class="searchbar" type="text" id="artistname" name="artistname">
     <input class="searchbtn" type="submit" name="search" value="অনুসন্ধান">
     </p>
     </form>
                            ...
                            <table class="pic-table">
                                <tr>
                                    <td>
                                        ...
                                        <a class="desc-content2" href="artist_info.php?id='.$row['user_id'].'">  বিস্তারিত. . . </a>
                                    </td>
                                </tr>
                            </table>
                        </div>';
