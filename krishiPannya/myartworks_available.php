...
function YNconfirm() {
    ...
    <div class="img">
        ...
        <?php
$id = $_SESSION['USER_ID'];
echo '<p><h1 class="head-available"> বিক্রয়ের </h1>
                <h1 class="head-artworks">জন্য<hr class="hr"></p>';
  echo                '<a class="addbtn" href="select_art.php" style=""> &#10133;  যুক্ত করুন</a>';
 ...
 if(mysqli_num_rows($result_category) <=0)
        {
            echo '<br><br><br><h1 align="Center">কোন পণ্য নেই </h1>';
        }
        else{
