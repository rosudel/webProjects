...
$query_category="SELECT buy_transaction.transaction_id,buy_transaction.delivery_date,buy_transaction.ordered_no,buy_transaction.ordered_date,buy_transaction.total_price,buy_transaction.shipping_status,user.user_email,buy_transaction.courier_name
      ...
      echo '
      <a href = "orders(planb).php"> পিছনে যান </a>
      <div class="whiteborder">
        <h3> প্রিয় '.$courier_name.',</h3>

         <p>
            আপনার অর্ডার নম্বর # '.$id.',&nbsp;&nbsp;&nbsp;&nbsp;'.$ordered_date.'&nbsp;&nbsp;&nbsp;&nbsp;তারিখে সারি তে যুক্ত হয়েছে ক্যাশ অন ডেলীভারী শর্তে.
            <br><br>

            Note:<br><br>
            In the event that the information you provided is incomplete, a validation may be sent through phone call or SMS as part of krishipanna\'s order verification requirement.<br> Please be kind enough to respond if you receive either a call from krishipanna or an SMS from sender krishipanna team. If you do not receive any communication from us <br>your order will automatically be processed.<br><br>
            Order validations will be conducted between 8am and 9pm, from sat to thu. Failure to respond to either the call or the SMS will result in order cancellation/s.<br><br>
      ...
      <div class="whiteborder">
        <h3> Dear '.$courier_name.',</h3>
         ...
         <p>
           ...
           <br><br>
            If you have any complaints regarding the item you bought, Please contact the owner of this item by visiting <a href="artist.php"> Seller page </a>. Thank you and have a good day!
        </p>
        </div>
        ';
