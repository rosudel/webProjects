...
function YNconfirm() {
  ...
  <div class="border">
               <h2 class="headt1"> একাউন্ট </h2>
               <h2 class="headt2"> &nbsp; প্রোফাইল</h2>
      </div>

   <form action = "action_profile.php"enctype="multipart/form-data" method="POST">
<h2 class="headspace font infospace">  একাউন্ট এর তথ্য <hr class="hr" style="border-bottom: 4px solid #2d70d5;"> </h2>


<p class="fsize-title"> প্রোফাইল ফটো: </p>
            <p class="fsize-img">
<?php
...
<input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
 ...
 <p class="fsize-text">
                      ইউজার নাম:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" required name="username" value="<?php echo $username; ?>"><br><br>

                       পাসোয়ার্ড:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" required name="password" value="<?php echo $password; ?>"><br><br>


        <h2  class="headspace2 font infospace"> ব্যক্তিগত তথ্য <hr class="hr" style="border-bottom: 4px solid #2d70d5;"> </h2>

            <div class="spacing">
            নামের প্রথম অংশ:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="Fname" required name="Fname" value="<?php echo $fname; ?>"><br><br>

             মধ্য অংশ:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="Mname" name="Mname" value="<?php echo $mname; ?>"><br><br>

             শেষ অংশ:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="Lname" required name="Lname" value="<?php echo $lname; ?>"><br><br>

             লিঙ্গ:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="gender" required name="gender" value="<?php echo $gender; ?>"><br><br>

            জন্মতারিখ:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="bday" name="bday" value="<?php echo $bday; ?>"><br><br>

            কন্টাক্ট নাম্বার:&nbsp;&nbsp;<input class="textbox" type="text" id="contact" required name="contact" value="0<?php echo $contact; ?>"><br><br>
             ইমেইল:&nbsp;&nbsp;<input class="textbox" type="text" id="contact" required name="email" value="<?php echo $email; ?>"><br><br>

            থানা:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="municipal" name="municipal" value="<?php echo $municipal; ?>"><br><br>

            জেলা:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="textbox" type="text" id="province" name="province" value="<?php echo $province; ?>"><br><br>
            পোস্ট কোড:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="zipcode" name="zipcode" value="<?php echo $zipcode; ?>"><br><br>
             অঞ্চল:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="Brgy" name="Brgy" value="<?php echo $brgy; ?>"><br><br>
             পাড়া:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="Street" name="Street" value="<?php echo $street; ?>"><br><br>
            বাড়ি নং:&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="House_num" name="House_num" value="<?php echo $house; ?>"><br><br>

             </div>
                <input class="inputbar" type="submit" name="submit" value="সাবমিট করুন">
